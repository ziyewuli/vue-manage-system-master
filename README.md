# manage-system #
基于Vue.js 2.x系列 + Element UI 的后台管理系统解决方案。[线上参考地址](http://blog.gdfengshuo.com/example/work/)
...
## 安装步骤 ##
	...
	git clone https://github.com/ziyewuli/vue-manage-system-master.git      // 把模板下载到本地
