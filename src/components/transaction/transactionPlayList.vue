<template>
    <div class="table" v-loading.body="">
        ...
        <div class="handle-box">
            ...
            <el-input placeholder="打款人" class="handle-input mr10"></el-input>
            <el-input placeholder="到账银行卡号" style="width:240px;"></el-input>
        ...
        <el-table :data="tableData" border style="width: 100%" ref="multipleTable">
            ...
            <el-table-column prop="" label="借款产品" >
              ...
              <el-table-column prop="" label="借款期限" width="100">
              </el-table-column>
            ...
            <el-table-column prop="" label="审核情况" >
              ...
              <el-table-column prop="" label="风险级别" width="100" >
              </el-table-column>
              <el-table-column prop="" label="报告详情" width="100" >
                <template scope="scope">
                  <el-button type="text" size="small" @click="auditReport()">报告详情</el-button>
                </template>
              </el-table-column>
            </el-table-column>
            <el-table-column prop="" label="打款情况">
              <el-table-column prop="" label="打款人" >
              </el-table-column>
              <el-table-column prop="" label="打款金额" width="100">
              </el-table-column>
              <el-table-column prop="" label="打款时间" width="100" >
              </el-table-column>
              <el-table-column prop="" label="到账银行卡号" >
              </el-table-column>
              <el-table-column prop="" label="到账状态" width="100" >
              </el-table-column>
              <el-table-column prop="" label="到账时间" width="100" >
              </el-table-column>
              <el-table-column prop="" label="打款备注" width="100" >
              </el-table-column>
            </el-table-column>
        </el-table>
